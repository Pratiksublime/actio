...
const updateolympic = async (req, res) => {
    try {
        console.log('wwwwwwwwwwwwwwwwwwwweeeeeeeeeeeqqqqq');
        ...
        console.log('req.body.olympic_fee9999999999999999999999');
        console.log(req.body.olympic_fee);
        if (req.body.olympic_fee) {

            console.log('olympic_fee7777777777777777777');
            await db.query(`UPDATE ${process.env.SCHEMA}.olympic_fee
            SET currency = ${req.body.olympic_fee.currency},
            ...
            updated_at = now()
            WHERE id = ${req.body.olympic_fee.id}`) 
        } 
