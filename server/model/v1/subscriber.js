...
const adhar_statusupdate = async(req,res)=>{
try{
    let query = "update subscriber_profile set adhar_status = "+req.body.adhar_status+" WHERE subscriber_id = "+req.body.id+"";
...
module.exports = {
    ...
    updateRelationship, parentMobileUser, requestParentUser, isParentByID, list, listMaster, profile, editSubscriber,adhar_statusupdate
}