...
const edit = async (req, res) => {
    ...
    try {
        ...
        if (typeof (req.body.registration_fee) != "undefined" && req.body.registration_fee != '') {
            eventUpdateStr += " , registration_fee='" + req.body.registration_fee + "'";
        }
...
module.exports = {
    ...
    eventControllerAdd, nonActioEdit, nonActioView, nonActiolist, master, add, list, allowEdit, edit, validDate, eventControllerList, eventUpload,deletedata,editevent
}
