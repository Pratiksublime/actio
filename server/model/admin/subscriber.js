...
const updateProfile = async (req, res) => {
    try {
        ...
        var id = req.body.subscriber_id;
         ...
         console.log('req.body.sub_status')
         console.log(id)
        let editForm = {
            // Screen 1 
...
const getHighlightedVideos = async (req, res) => {
    try {
        ...
        let query = await db.query(`SELECT * FROM subscriber_highlighted_videos
...
module.exports = {
    ...
    updateSportsProfile, getSportsProfile, updateProfessionProfile, getProfessionProfile,Mytournamentlist,Myeventlist_byid,deletesubscriberdata
}