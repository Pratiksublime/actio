...
//new2 filter code 
   ...
   // let finalQuery = {};
	...
	// var querynew = "SELECT t.id,t.olympics_sports,o.olympic_sports,t.registration_fee,o.olympic_name,o.olympic_description,o.olympic_venue,va.venue_name as olympic_venue_name,o.olympic_country,oct.name as olympic_country_name,o.olympic_city,o.olympic_state,o.olympic_start_date,o.olympic_end_date,o.olympic_sports, t.is_champ, t.tournament_description,t.tournament_name,s.sports_name,s.id as sport_id ,t.is_live, t.tournament_start_date, t.tournament_start_time, t.tournament_end_date, t.tournament_end_time, t.tournament_venue, v.venue_name, t.tournament_city,cts.city_name as olympic_city_name, ct.city_name,osp.state_name as olympic_state_name, t.tournament_country, c.name FROM tournament AS t  LEFT JOIN olympic as o on o.id = t.olympics_sports LEFT JOIN country AS oct ON oct.id = o.olympic_country LEFT JOIN state AS osp ON osp.id = o.olympic_state LEFT JOIN venue AS va ON va.id = o.olympic_venue LEFT JOIN city AS cts ON cts.id = o.olympic_city LEFT JOIN venue AS v ON v.id = t.tournament_venue LEFT JOIN city AS ct ON ct.id = t.tournament_city LEFT JOIN sports AS s ON s.id = t.sports:: integer LEFT JOIN country AS c ON c.id = t.tournament_country where t.status=1"+where_str+sports_name+city_name+UpcomingList_data+pastList_data+live_data

    var querynew = "SELECT t.id,t.olympics_sports,o.olympic_sports,t.registration_fee,o.olympic_name,o.olympic_description,o.olympic_venue,va.venue_name as olympic_venue_name,o.olympic_country,oct.name as olympic_country_name,o.olympic_city,o.olympic_state,o.olympic_start_date,o.olympic_end_date,o.olympic_sports, t.is_champ, t.tournament_description,t.tournament_name,t.is_live, t.tournament_start_date, t.tournament_start_time, t.tournament_end_date, t.tournament_end_time, t.tournament_venue, v.venue_name, t.tournament_city,cts.city_name as olympic_city_name, ct.city_name,osp.state_name as olympic_state_name, t.tournament_country, c.name FROM tournament AS t  LEFT JOIN olympic as o on o.id = t.olympics_sports LEFT JOIN country AS oct ON oct.id = o.olympic_country LEFT JOIN state AS osp ON osp.id = o.olympic_state LEFT JOIN venue AS va ON va.id = o.olympic_venue LEFT JOIN city AS cts ON cts.id = o.olympic_city LEFT JOIN venue AS v ON v.id = t.tournament_venue LEFT JOIN city AS ct ON ct.id = t.tournament_city LEFT JOIN country AS c ON c.id = t.tournament_country where t.status=1"+where_str+sports_name+city_name+UpcomingList_data+pastList_data+live_data
...
const eventlist = async (req, res) => {
    ...
    try {
        ...
        var queryfilter = "SELECT t.*, s.sports_name,g. gender,a.min_age,a.max_age, v.venue_name FROM event AS t  LEFT JOIN venue AS v ON v.id = t.venue_id LEFT join age_group as a ON a.id = t.id LEFT join gender as g ON g.id = t.player_type_id LEFT join sports as s ON s.id = t.sports_id "+where_str+gender+age;
...
module.exports = { UpcomingList, pastList, withoutPastList, countList,detailsList, info, insert, update ,eventlist,championList ,tournamentlist_bychamp,sportList,locationtList,UpcomingListNew,PastListNew,detailsListNew}  