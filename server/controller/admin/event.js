...
const eventModel = require('../../model/admin/event');
...
module.exports = {
    ...
    eventControllerEdit, master, create, list, edit, nonActiolist, nonActioView, nonActioEdit, eventControllerList, eventUpload,deletedata,editevent
}