...
const subscriberController = require('../../../controller/v1/admin/subscriber');
...
module.exports = (app) => {
    ...
    //..............................................
    app.post('/v1/admin/subscriber/educationProfileInsert',auth.userAuth,subscriberController.EducationProfileInsert);
    app.post('/v1/admin/subscriber/educationProfileUpdate',auth.userAuth,subscriberController.EducationProfileUpdate);
    
    app.post('/v1/admin/subscriber/addmySports',auth.userAuth,subscriberController.addMySports); 
    app.post('/v1/admin/subscriber/updateSport',auth.userAuth,subscriberController.updateSport); 
    app.post('/v1/admin/subscriber/addmyteam',auth.userAuth,subscriberController.addMyteam); 
    app.post('/v1/admin/subscriber/addmySponsor',auth.userAuth,subscriberController.addMySponsor);  

    app.post('/v1/admin/subscriber/updatemysponsorweb',auth.userAuth,subscriberController.updateMySponsorweb);
    app.post('/v1/admin/subscriber/insertgallery',auth.userAuth,subscriberController.insertGallery); 
    app.post('/v1/admin/subscriber/updategallery',auth.userAuth,subscriberController.updateGallery); 

    app.post('/v1/admin/subscriber/insertvideos',auth.userAuth,subscriberController.insertVideos); 
    app.post('/v1/admin/subscriber/updatevideos',auth.userAuth,subscriberController.updateVideos); 

    app.post('/v1/admin/subscriber/deleteall',auth.userAuth,subscriberController.deleteAll); 
