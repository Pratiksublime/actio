...
const masterController = require('../../controller/v1/admin/master');
const masterOlympicController = require('../../controller/v1/admin/masterOlympic');
...
module.exports = (app) => {
    ...
    app.get('/v1/admin/master/currency', masterController.currency);
    ...
    const searchSubscriberValidationolympic = [
        body('search_string').isLength({ min: 1 }).isString(),
        body('limit')
            .isNumeric()
            .isLength({ max: 5 })
    ...
    app.get('/v1/admin/master/olympic_list',  masterOlympicController.olympic_list);

    app.post('/v1/admin/master/olympic_sport_list',  masterOlympicController.olympic_sport_list);


    app.post('/v1/admin/master/olympic',  masterOlympicController.olympic);
    app.post('/v1/admin/master/olympicDetails',  masterOlympicController.details);
    app.post('/v1/admin/master/olympicCreate',  olympicCreateValidation, masterOlympicController.olympicCreate);
    app.post('/v1/admin/master/olympicVenueFilter',  masterOlympicController.filterVenue);
    app.post('/v1/admin/master/olympicSearchSubscriber', masterOlympicController.searchSubscriber);
}