...
app.post('/v1/admin/master/addskill',addController.AddSkill);
app.get('/v1/admin/master/skilllist',addController.Skilllist);

app.get('/v1/admin/master/headerlist',addController.Headerlist);


app.get('/v1/admin/master/sportslistbyid',addController.sportslistbyid);

app.get('/v1/admin/master/dashbordCount',userAuth,addController.dashbordCount); 


app.get('/v1/admin/master/Piechartcountdata',addController.Piechartcountdata); 
//app.get('/v1/admin/master/LineGraphcount',addController.LineGraphcount); 
